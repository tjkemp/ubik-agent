...
class TestPrioritizedReplayBuffer:
    ...
    def test_samples_are_in_range(self):
        ...
        # unfortunately, to test this properly we need to check internals
    ...
    def test_sample_priorities_are_updated(self):
        ...
        # unfortunately, to test this properly we need to check internals
        assert buffer.sumtree.sum == priority * buffer_size
        ...
        # randomness involved, so we don't know the exact priorities
        assert buffer.sumtree.sum > 100.0
